 ...
 * @author Syed
 */
public class TS_Servlet extends HttpServlet {
     ...
     */
    private static final String VENUE_GLOBAL_DETAILS_URL = "https://www.everyoneactive.com/centre/alton-sports-centre/";

    private static final String VENUE_NAME_DIV_CLASS_META = "div[itemprop = image] > meta[content*= .jpg]";
    ...
    //Make a class named Venue and store all details related.
    class Venue {
    ...
    //Scraping using JSoup library and use setters to set the content.
    ...
    public List<Venue> extractVenues() {
        ...
        if (!priceElements.isEmpty()) {
            venue.setPrice(priceElements.val() + "£8.70");
        }
        ...
        for (Venue venue : venues) {
            ...
            try (PrintWriter out = new PrintWriter(response.getOutputStream())) {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                    <tr>\n"
                        + "                        <td><img src= \"" + venue.getImg() + "\" alt=\"Gymnasium_logo\" width=\"1300\" height=\"550\"></td> \n"
                        + "                    </tr> \n"
                        + "            </table>     \n"
                        + "    </div> \n"
                        + "    \n"
