...
//The links can show some message 

/**
 *
 * @author Syed
 */
public class VB_Servlet extends HttpServlet {
     ...
     *
     */
    private static final String VENUE_GLOBAL_DETAILS_URL = "https://www.everyoneactive.com/centre/paddington-recreation-ground/";
    ...
    public List<Venue> extractVenues() {
        ...
        if (!priceElements.isEmpty()) {
            venue.setPrice(priceElements.val() + "£67.50");
        }
        ...
        for (Venue venue : venues) {
            ...
            try (PrintWriter out = new PrintWriter(response.getOutputStream())) {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                    <tr>\n"
                        + "                        <td><img src= \"" + venue.getImg() + "\" alt=\"volleyball_logo\" width=\"1300\" height=\"550\"></td> \n"
                        + "                    </tr> \n"
                        + "            </table>     \n"
                        + "    </div> \n"
                        + "    \n"
